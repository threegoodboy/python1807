# Generated by Django 2.2.1 on 2019-05-24 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vip_level', models.CharField(default='青铜', max_length=30)),
            ],
            options={
                'verbose_name': '用户模型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='check_user', to='myapp.Users')),
            ],
            options={
                'db_table': 'check_user',
            },
